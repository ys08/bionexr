---
title: "Bionexr: an R package for integrative network-based analysis of gene somatic mutation and gene expression data to identify cancer drivers"
author: "Yang Shuai"
date: "`r Sys.Date()`"
...
- A protein-protein interaction network (PPIN)-based approach
- A pathway-based appoach
- Visualization of the result in a network view
...
<img src = "../fig/overview.JPG" width = "700" align = "center" />
